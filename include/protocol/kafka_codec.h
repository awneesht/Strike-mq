...
public:
    ...
    int16_t read_int16() { uint16_t v; std::memcpy(&v, data_ + pos_, 2); pos_ += 2; return static_cast<int16_t>(strike::bswap16(v)); }
    int32_t read_int32() { uint32_t v; std::memcpy(&v, data_ + pos_, 4); pos_ += 4; return static_cast<int32_t>(strike::bswap32(v)); }
    int64_t read_int64() { uint64_t v; std::memcpy(&v, data_ + pos_, 8); pos_ += 8; return static_cast<int64_t>(strike::bswap64(v)); }
...
public:
    ...
    void write_int16(int16_t v) { uint16_t be = strike::bswap16(static_cast<uint16_t>(v)); std::memcpy(data_ + pos_, &be, 2); pos_ += 2; }
    void write_int32(int32_t v) { uint32_t be = strike::bswap32(static_cast<uint32_t>(v)); std::memcpy(data_ + pos_, &be, 4); pos_ += 4; }
    void write_int64(int64_t v) { uint64_t be = strike::bswap64(static_cast<uint64_t>(v)); std::memcpy(data_ + pos_, &be, 8); pos_ += 8; }
    ...
    void patch_size(size_t ph) {
        ...
        uint32_t be = strike::bswap32(static_cast<uint32_t>(sz));
